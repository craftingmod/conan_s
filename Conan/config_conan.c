...
struct Tag tags[] = {
	...
	{ L"좋아", L"좋아한다는 내용이 담긴 곡인가요?" },//31
	{ L"오류", L"사용하지 않는 태그 번호입니다." }//끝
	,{NULL,NULL} //EndPointer
};

struct Music music[] = {
	{ L"나의 사춘기에게", L"볼빨간사춘기" ,{ 3,4,7,14,18,26 } },//0
	{ L"좋니", L"윤종신" ,{ 1,2,6,7,14,18 ,31} },//0
	{ L"좋아", L"윤종신" ,{ 1,2,3,4,6,10,11 ,31} },//0
	{ L"그리워하다", L"비투비" ,{ 1,2,7,9, 8,11,15 } },//0
	{ L"밤이 되니까", L"펀치" ,{ 3,4,6,7,18,27,29 } },//0
	{ L"사랑하지 않은 것처럼", L"버즈" ,{ 1,2,6,7,9,14,18,24 } },//0
	{ L"비도 오고 그래서", L"헤이즈" ,{ 1,2,3,5,7,10,11,14, 29 } },//0
	{ L"선물", L"멜로망스" ,{ 1,2,12,17,18 } },//0
	{ L"가을 아침", L"아이유" ,{ 3,4,13,17,18 } },//0
	{ L"All Of My Life", L"박원" ,{ 1,2,6,7,9,14,15,18,24 } },//0
    { L"보노보노 OP", L"임지숙" ,{ 3,4,13, 16,18} },//0
	{ L"썸탈거야", L"볼빨간사춘기" ,{ 1,3,12,17,18,21,29 } },//0
	{ L"시차(We Are) (Feat. 로꼬& Gray)", L"우원재" ,{ 2, 8,10, 11, 15, 19, 25} },//0
	{ L"Blue", L"볼빨간사춘기" ,{ 1,3,6,7, 15,18,30,31 } },//0
	{ L"가시나", L"선미" ,{ 1,3,6,7,15,18,19 } },//
	{ L"밤편지", L"아이유" ,{ 1,3,4,7,9,12,13,18 , 28} },//16
	...
	{ L"남이 될 수 있을까", L"볼빨간사춘기, 스무살" ,{ 1,2,3,5,6,7,9,10,11,15 } },//22
	{ L"널 너무 모르고", L"헤이즈" ,{1,3,6,7,8,15,18 ,24} },//23
